...
_m_>0，则该方每开一次枪都会消耗 1 体力。每一轮该方都有 1/(_n_+1) 的概率回复 1
体力。当 _m_<8 时，该方有 1-_m_/8 的概率晕一轮。  
...
的概率炸膛；否则，对于射出的每发子弹有 1-pow(1535/1536,_h_+60)
...
_未实装_
##### 道具 33：枪筒维修
让炸膛指数变为原来的 2/3，并告诉你“你维修了一下枪筒”。若炸膛指数小于等于
0，则不会使用。
### 游戏模式介绍
#### 1. 普通模式
只有 1 个周目。  
